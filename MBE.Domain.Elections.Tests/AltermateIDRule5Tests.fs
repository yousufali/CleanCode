...
module AlternateIDRule5Tests =

    [<Fact>]
    let ``AlternateId Rule 5 Test when Alternate Id exists for Day before Effective Date Election``() =
        ...
        let rule5Calculator = new Rule5Calculator();

        let expected = [| new UserAlternateID( UserID = 1500, AlternateID = "1");
                          new UserAlternateID( UserID = 1501, AlternateID = "2"); |]

        let actual = rule5Calculator.GetAlternateID(benefitElectionAlternateIDs, coveredUsers, DateTime.Parse "1/1/2016")

        Assert.Equal(expected, actual)

    [<Fact>]
    let ``AlternateId Rule 5 Test when child added ``() =
        let benefitElectionAlternateIDs = [| new BenefitElectionAlternateID(UserID = 1500, ParentUserID = 1500, PlanTypeID = 1, BenefitStartDate = DateTime.Parse "1/1/2015",
                                                  BenefitEndDate = DateTime.Parse "12/31/2015", AlternateID = "1");
                                             new BenefitElectionAlternateID(UserID = 1501, ParentUserID = 1500, PlanTypeID = 1, BenefitStartDate = DateTime.Parse "1/1/2015",
                                                 BenefitEndDate = DateTime.Parse "12/31/2015", AlternateID = "2");  |] |> List
    ...
    [<Fact>]
    let ``AlternateId Rule 5 Test when spouse added with a child already covered``() =
        let benefitElectionAlternateIDs = [| new BenefitElectionAlternateID(UserID = 1500, ParentUserID = 1500, PlanTypeID = 1, BenefitStartDate = DateTime.Parse "1/1/2015",
                                                  BenefitEndDate = DateTime.Parse "12/31/2015", AlternateID = "1");
        ...
        let expected = [| new UserAlternateID( UserID = 1500, AlternateID = "1");
                          new UserAlternateID( UserID = 1501, AlternateID = "3");
    ...
    [<Fact>]
    let ``AlternateId Rule 5 Test when enrolled first time by user``() =
