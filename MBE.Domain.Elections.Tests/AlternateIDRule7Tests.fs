...
module AlternateIDRule7Tests =

    [<Fact>]
    let ``AlternateId Rule 7 Test when Alternate Id exists for Day before Effective Date Election``() =
        ...
        let rule7Calculator = new Rule7Calculator();

        let expected = [| new UserAlternateID( UserID = 1500, AlternateID = "0");
                          new UserAlternateID( UserID = 1501, AlternateID = "1"); |]

        let actual = rule7Calculator.GetAlternateID(benefitElectionAlternateIDs, coveredUsers, DateTime.Parse "1/1/2016")

        Assert.Equal(expected, actual)

    [<Fact>]
    let ``AlternateId Rule 7 Test when child added ``() =
        let benefitElectionAlternateIDs = [| new BenefitElectionAlternateID(UserID = 1500, ParentUserID = 1500, PlanTypeID = 1, BenefitStartDate = DateTime.Parse "1/1/2015",
                                                  BenefitEndDate = DateTime.Parse "12/31/2015", AlternateID = "0");
                                             new BenefitElectionAlternateID(UserID = 1501, ParentUserID = 1500, PlanTypeID = 1, BenefitStartDate = DateTime.Parse "1/1/2015",
                                                 BenefitEndDate = DateTime.Parse "12/31/2015", AlternateID = "1");  |] |> List
    ...
    [<Fact>]
    let ``AlternateId Rule 7 Test when spouse added with a child already covered``() =
        let benefitElectionAlternateIDs = [| new BenefitElectionAlternateID(UserID = 1500, ParentUserID = 1500, PlanTypeID = 1, BenefitStartDate = DateTime.Parse "1/1/2015",
                                                  BenefitEndDate = DateTime.Parse "12/31/2015", AlternateID = "0");
                                              new BenefitElectionAlternateID(UserID = 1502, ParentUserID = 1500, PlanTypeID = 1, BenefitStartDate = DateTime.Parse "1/1/2015",
                                                  BenefitEndDate = DateTime.Parse "12/31/2015", AlternateID = "2"); |] |> List
    ...
    [<Fact>]
    let ``AlternateId Rule 7 Test when enrolled first time by user``() =
    ...
    [<Fact>]
    let ``AlternateId Rule 7 Test when child added with no spouse on covered``() =
        let benefitElectionAlternateIDs = [| new BenefitElectionAlternateID(UserID = 1500, ParentUserID = 1500, PlanTypeID = 1, BenefitStartDate = DateTime.Parse "1/1/2015",
                                                  BenefitEndDate = DateTime.Parse "12/31/2015", AlternateID = "0"); |] |> List
